...
// export const Popular = ({ type, name, className }: any) => {
//   const [movieData, setMovieData] = useState<myTypes[]>([]);
//   const router = useRouter();

//   const handleOneClick = (id: number) => {
...
//     axios
//       .get(
//         `https://api.themoviedb.org/3/movie/${type}?language=en-US&page=1&api_key=d67d8bebd0f4ff345f6505c99e9d0289`
//       )
...
//         <h2 className="text-[24px] font-semibold pb-[32px]">{name}</h2>
//         <Button
...
//             key={value.title}
//             title={value.title}
//             onClick={() => handleOneClick(value.id)}
